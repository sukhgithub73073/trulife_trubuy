        ...
        actions: [
          BlocConsumer<ThemeBloc, ThemeState>(
            ...
            builder: (context, state) {
              return IconButton(
                onPressed: () {
                  context.read<ThemeBloc>().add(ChangeThemeEvent(themeEnum: state is ThemeDark ? ThemeEnum.light : ThemeEnum.dark)) ;
                },
                icon: SvgPicture.asset(
                  state is ThemeDark ? "assets/icons/theme_light.svg" : "assets/icons/theme_dark.svg",
                  height: 24,
                  colorFilter: ColorFilter.mode(
